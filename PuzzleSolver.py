...
if(puzzlePiece1GridPosition.getColumn()>puzzlePiece2GridPosition.getColumn() and
puzzlePiece1GridPosition.getColumn()-puzzlePiece2GridPosition.getColumn()==1):
...
elif(puzzlePiece2GridPosition.getColumn()>puzzlePiece1GridPosition.getColumn() and
puzzlePiece2GridPosition.getColumn()-puzzlePiece1GridPosition.getColumn()==1):
...
if(puzzlePiece2GridPosition.getRow()>puzzlePiece1GridPosition.getRow() and
puzzlePiece2GridPosition.getRow()-puzzlePiece1GridPosition.getRow()==1):
...
elif(puzzlePiece1GridPosition.getRow()>puzzlePiece2GridPosition.getRow() and
puzzlePiece1GridPosition.getRow()-puzzlePiece2GridPosition.getRow()==1):
